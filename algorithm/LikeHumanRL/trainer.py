...
from algorithm.LikeHumanRL.actor_critic import ActorCritic
...
def trainer(log_dir: str, env_mode: str, encoder_model_path, expert_data_name, replay_mode='default', update_mode='value'):
...
if __name__ == '__main__':
    trainer(log_dir="log/merge10/", env_mode="merge", encoder_model_path="", expert_data_name="" ,update_mode='value')
