...
def trainer(log_dir: str, env_mode: str, encoder_model_path, expert_data_name):
    ...
    while True:
        ...
        while True:
            ...
            reward = model.get_discriminator_reward(obs, action)
            obs_, _, done, _, info = train_env.step(action)
            obs_ = obs_ / 255.0
...
if __name__ == '__main__':
    ...
    trainer(log_dir="log/GAIL_radical_left_t1/", env_mode="left_t", encoder_model_path=args.encoder_model_path, expert_data_name=args.expert_data_name)
