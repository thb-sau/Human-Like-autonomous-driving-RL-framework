...
config = load_config('config.yaml', 'SAC')
...
def trainer(log_dir: str, env_mode: str, encoder_model_path, reeplay_mode='default'):
...
if __name__ == '__main__':
    ...
    trainer(log_dir="log/SAC_left_t1/", env_mode="left_t", encoder_model_path=args.encoder_model_path)
